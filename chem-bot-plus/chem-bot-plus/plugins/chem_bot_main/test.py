...
def image_symmetrize(file_path:str,direction:str)->str:
	with Image.open(file_path) as img:
		...
		if img.format=='GIF':
			...
			new_frames[0].save(file2,save_all=True,append_images=new_frames[1:],loop=0)
			return file2
		else:
...
filepath=r'E:\Songcf\Desktop\725E901E21BD0D324320A1AD7E3133F7.gif'
newgif=image_symmetrize(filepath,'左')
print(newgif)